...
\todo[inline]{I think this is a good middle ground since I do want to introduce the results of having the L and U matrices, without having to go through the LU decomposition until we know what L and U mean, but I still want to correctly introduce L and U}
...
\todo[inline]{Provide better descriptions of the systems here, as mentioned by David and by the feedback from the interim report. Also fix image heights}
...
Due to the complexity of the semi-naive inverse module, this FPGA was only sufficient for the $4 \times 4$ matrix modules at most. Despite this \todo[inline]{Some synthesis runs still need to finish, will finish this section after that}
